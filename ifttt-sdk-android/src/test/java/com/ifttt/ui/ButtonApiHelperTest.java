...
public final class ButtonApiHelperTest {
    ...
    public void testRequiredFields() {
        Uri uri = ButtonApiHelper.getEmbedUri(connection, Initial, "http://redirect", "abc@efg.com", "", "auth_code",
                null);
    ...
    public void testOAuthCode() {
        ...
        Uri uri1 = ButtonApiHelper.getEmbedUri(connection, CreateAccount, "http://redirect", "abc@efg.com", "",
                "auth_code", "abcd");
        assertThat(uri1.getQueryParameter("code")).isEqualTo("auth_code");

        Uri uri2 = ButtonApiHelper.getEmbedUri(connection, Login, "http://redirect", "abc@efg.com", "", "auth_code",
                "abcd");
