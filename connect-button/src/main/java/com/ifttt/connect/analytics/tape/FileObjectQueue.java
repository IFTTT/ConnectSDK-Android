...
final class FileObjectQueue<T> extends ObjectQueue<T> {
    ...
    private final FileObjectQueue.DirectByteArrayOutputStream
            bytes = new FileObjectQueue.DirectByteArrayOutputStream();
    ...
    @Override public Iterator<T> iterator() {
        return new FileObjectQueue.QueueFileIterator(queueFile.iterator());
    }
